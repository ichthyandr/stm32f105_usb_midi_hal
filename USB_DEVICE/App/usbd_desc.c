...
#define USBD_PID_FS     				0xDF01 //22336
#define USBD_LANGID_STRING     			1033
#define USBD_MANUFACTURER_STRING     	"BJ devices"
#define USBD_PRODUCT_STRING_FS     		"BJ devices USB-MIDI"
#define USBD_SERIALNUMBER_STRING_FS     "000000000021" //"00000000001A"
...
uint8_t * USBD_FS_SerialStrDescriptor(USBD_SpeedTypeDef speed, uint16_t *length)
{
  ...
  *length = USB_SIZ_STRING_SERIAL;
  ...
  //USBD_StringSerial = {};
  memset(USBD_StringSerial,0,USB_SIZ_STRING_SERIAL);
